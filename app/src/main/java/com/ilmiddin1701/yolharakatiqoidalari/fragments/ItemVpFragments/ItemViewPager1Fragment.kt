...
import com.ilmiddin1701.yolharakatiqoidalari.databinding.FragmentItemViewPager1Binding
...
class ItemViewPager1Fragment : Fragment(), RvAdapter1.RvAction1 {
    private val binding by lazy { FragmentItemViewPager1Binding.inflate(layoutInflater) }
    ...
    override fun onResume() {
        ...
        rvAdapter1 = RvAdapter1(this@ItemViewPager1Fragment,list)
