...
import com.ilmiddin1701.yolharakatiqoidalari.databinding.FragmentItemViewPager3Binding
...
class ItemViewPager3Fragment : Fragment(), RvAdapter1.RvAction1 {
    private val binding by lazy { FragmentItemViewPager3Binding.inflate(layoutInflater) }
    ...
    override fun onResume() {
        ...
        rvAdapter1 = RvAdapter1(this@ItemViewPager3Fragment, list)
